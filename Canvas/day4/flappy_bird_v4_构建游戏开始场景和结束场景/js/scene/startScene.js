(function( w ) {
    ...
    function StartScene( options ) {
        ...
        this.text = options.text || 'Flappy Bird';
        this.btnText = options.btnText || '开始游戏';
        ...
        // 绘制背景
        this.ctx.canvas.style.backgroundImage = 'url(' + startBgBase64 + ')';
        this.ctx.canvas.style.backgroundSize = '100% 100%';
    }

    // 扩展原型方法
    util.extend( StartScene.prototype, {
